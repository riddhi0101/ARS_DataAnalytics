  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "social",
              ...
              fluidPage(
                fluidRow(
                  infoBox("Cities with Most Traffic: Davis, LA, San Diego, Sacramento",icon = icon("map"),fill = TRUE, color = "purple"),
                  infoBox("Top Age Range: 18-24",icon = icon("user"),fill = TRUE, color = "olive"),
                  infoBox("Profile Visits: 1,994",icon = icon("store"),fill = TRUE, color = "red"),
                  infoBox("% of Women Reached: 73.8%",icon = icon("thumbs-up"),fill = TRUE, color = "lime"),
                  infoBox("% of Men Reached: 26.1%",icon = icon("thumbs-up"),fill = TRUE, color = "lime")
